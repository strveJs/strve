...
function mount(vnode: vnodeType, container: HTMLElement | Node, anchor?: Node) {
	if (vnode.tag) {
...
function patch(n1: vnodeType, n2: vnodeType, status: string) {
...
function patchNode(o: any[], n: any[], el: HTMLElement, status: string) {
...
function updateTextNode(val: any, el: HTMLElement) {
...
export function setData(callback: Function, options: setDataOptionsType) {
