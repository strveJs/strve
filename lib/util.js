...
const isSVG = makeMap('svg,animate,circle,clippath,cursor,image,defs,desc,ellipse,filter,font-face' +
...
export function isHasFlag(props, flag) {
 ...
 * API
 */
export function emit(eventName, data, el) {
